...
namespace PicturesAPI.Migrations
{
    ...
    [Migration("20220106013655_Dislike.Id-int,Like.Id-int")]
    partial class DislikeIdintLikeIdint
    {
            ...
            modelBuilder.Entity("PicturesAPI.Entities.Account", b =>
                {
                    ...
                    b.Property<DateTime>("AccountCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 1, 6, 2, 36, 55, 118, DateTimeKind.Local).AddTicks(4296));
            ...
            modelBuilder.Entity("PicturesAPI.Entities.Picture", b =>
                {
                    ...
                    b.Property<DateTime>("PictureAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 1, 6, 2, 36, 55, 112, DateTimeKind.Local).AddTicks(3649));
